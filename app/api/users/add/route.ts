...
export async function POST(request: NextRequest) {
  try {
    ...
    const sql = `
      INSERT INTO users (id, created_at, last_modification, enabled, username, firstName, lastName)
      VALUES (@id, @createdAt, @lastModification, @enabled, @username, @firstName, @lastName)
    `;
